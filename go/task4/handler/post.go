...
func PostCreateHandler(db *gorm.DB) gin.HandlerFunc {
...
func QueryPostListByUserId(db *gorm.DB) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		postResults, postError := services.ReadPostListByUserIDService(c, db, models.Post{UserID: postByUserId.UserId})
		if postError != nil {
			c.JSON(200, gin.H{
				"code":   200,
