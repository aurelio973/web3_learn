...
func CreateCommentByPostIdHandler(db *gorm.DB) gin.HandlerFunc {
	return func(c *gin.Context) {
		var commentByPostId CommentByPostId
...
func QueryCommentByPostIdHandler(db *gorm.DB) gin.HandlerFunc {
	return func(c *gin.Context) {
		var commentByPostId CommentByPostId
